...
class PodServiceEvent(BaseModel):
    """
    PodServiceEvent
    """ # noqa: E501
    ...
    operation: StrictStr = Field(description="The operation performed on the service.")
    status: StrictStr = Field(description="The status for the operation, either 'ok' or 'error'.")
    __properties: ClassVar[List[str]] = ["event", "message", "service", "operation", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PodServiceEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PodServiceEvent from a dict"""
        if obj is None:
            return None
