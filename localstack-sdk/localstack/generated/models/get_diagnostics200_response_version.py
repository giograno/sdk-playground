...
class GetDiagnostics200ResponseVersion(BaseModel):
    ...
    image_version: GetDiagnostics200ResponseVersionImageVersion = Field(
        alias="image-version"
    )
    localstack_version: GetDiagnostics200ResponseVersionLocalstackVersion = Field(
        alias="localstack-version"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "host": GetDiagnostics200ResponseVersionHost.from_dict(obj["host"])
                if obj.get("host") is not None
                else None,
                "image-version": GetDiagnostics200ResponseVersionImageVersion.from_dict(
                    obj["image-version"]
                )
                if obj.get("image-version") is not None
                else None,
                "localstack-version": GetDiagnostics200ResponseVersionLocalstackVersion.from_dict(
                    obj["localstack-version"]
                )
                if obj.get("localstack-version") is not None
                else None,
            }
        )
