...
class LocalstackPodsEnvironmentGet200Response(BaseModel):
    ...
    localstack_version: Optional[StrictStr] = Field(
        default=None, description="Version of LocalStack."
    )
    localstack_ext_version: Optional[StrictStr] = Field(
        default=None, description="Version of LocalStack Pro."
    )
    moto_ext_version: Optional[StrictStr] = Field(
        default=None, description="Version of Moto used within LocalStack."
    )
    pro: Optional[StrictBool] = Field(
        default=None, description="Indicates whether LocalStack PRO is activated."
    )
